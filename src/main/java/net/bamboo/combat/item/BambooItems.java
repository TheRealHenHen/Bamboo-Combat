...
public class BambooItems {
    ...
    public static void initialize() {
        ...
        BAMBOO = register(new SpearItem(new SpearItemMaterial
            ...
            5, 1.6F, 1.1F, 3, false, 0, SpearEntityTypes.BAMBOO), "bamboo_spear");
